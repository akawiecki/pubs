...
Often described as “variance explained,” R2 is defined as:
...
distributions (with discussion). Bayesian Analysis, 13(3):917–1007.

### **model comparison**

is a more general approach that uses multiple models to understand both how different variables influence pre- dictions and, in combination with a causal model, implied conditional indendencies among variables help us infer causal relationships.
